...
int injectProc(int PID){
    ...
    WaitForSingleObject_t   pWaitForSingleObject = (WaitForSingleObject_t) GetProcAddress(k32, "WaitForSingleObject");
    VirtualFreeEx_t         pVirtualFreeEx       = (VirtualFreeEx_t) GetProcAddress(k32, "VirtualFreeEx");
